        ...
        {reel && (
          <ScrollArea className="h-full">
            <div className="flex flex-col gap-6 p-6">
              ...
              {/* Header — large thumbnail on top */}
              <div className="flex flex-col gap-4">
                {/* Image */}
                <div
                  className={`relative w-full overflow-hidden rounded-xl ${
                    reel.media_type === "VIDEO" || reel.media_type === "REEL" ? "aspect-[9/16] max-h-[400px]" : "aspect-[4/5] max-h-[500px]"
                  }`}
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    { label: "Visitas", value: fmt(reel.metrics.plays || reel.metrics.reach) },
                    { label: "Alcance", value: fmt(reel.metrics.reach) },
                    ...
                    { label: "ER%", value: reel.metrics.engagement_rate.toFixed(1) + "%" },
                  ].map(({ label, value }) => (
                    <div
                      key={label}
                ...
                <p className="text-[9px] leading-relaxed mt-1" style={{ color: "var(--text-faint)", opacity: 0.6 }}>
                  ⚠️ Métricas vía Graph API de Meta. Pueden diferir de la app nativa de Instagram, que incluye surfaces adicionales (Explore, Recomendados, Facebook).
                </p>
              </div>
              ...
              <div className="flex flex-col gap-3">
                <span className="section-label">Comparación vs. el promedio histórico de tu cuenta</span>
